...
MoistureLogInfoCompleted <- MoistureLogInfo %>% filter(Moisture.Status == "Complete")
```


```{r}
MoistureLogInfoCompleted

```


<h1>Line graph for moisture levels compared to days in dry</h1>
...
<h1>Moisture Levels compared to days in dry for all strains</h1>
...
There are `r NumEquipIssues` Equipment Issues and `r NumQualIssues` Quality issues


<h1>List of strains that are ready for harvest</h1>
...
<h1>List of strains that have a recording two days ago (Need tested today)</h1>
...
<h1>LifeCycle of each strain</h1>
...
<h1>Starting weight compared to initial moisture reading</h1>
